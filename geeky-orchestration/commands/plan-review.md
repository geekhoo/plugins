...
Invoke the **`plan-review`** skill, passing along `$ARGUMENTS` (a planning package folder produced by `/geeky-plan` — if missing, scan `docs/` for the most recent folder containing an `implementation-plan.md` or `SPEC-*.md`).
