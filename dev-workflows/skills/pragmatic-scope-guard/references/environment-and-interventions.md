...
- Author durable skills/plugins in the `geekhoo-plugins` repo (resolve its path on this machine); do not alter `~\.claude\plugins\cache\` or global hooks unless requested.
