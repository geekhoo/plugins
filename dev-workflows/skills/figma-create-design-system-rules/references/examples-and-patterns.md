# Design System Rules — Examples, Patterns & Troubleshooting

Supporting reference for the `figma-create-design-system-rules` skill. The core
workflow (Steps 1–5) lives in `SKILL.md`; read this when you need a concrete
pattern to adapt — an example rule catalog, full worked examples, best practices,
or troubleshooting.
